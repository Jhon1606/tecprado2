    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" onclick="cerrarModals('Linea')" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <!-- Formulario -->
            <form action="../Controlador/add.php" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="cerrarModals('Linea')" class="btn btn-secondary btn-sm" data-bs-dismiss="modal"> Cerrar</button>
